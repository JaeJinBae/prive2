...
$(function(){
    ...
    $("#searchBtn").click(function(){
		...
		location.href="${pageContext.request.contextPath}/menu08_04${pageMaker.makeQuery(1)}&searchType="+searchType+"&keyword="+keyword;
	});
						    ...
						    <c:otherwise>
						        ...
						        <c:forEach var="item" items="${list}">
									<tr>
										<td>${num}</td>
										<td class="subject">
											<a href="${pageContext.request.contextPath}/menu08_04read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title}</a>
										</td>
							...
							<c:if test="${pageMaker.cri.page == 1}">
								...
								<c:if test="${fn:length(topList) != 0}">
									<c:forEach var="item" items="${topList}">
										<li>
											<a href="${pageContext.request.contextPath}/menu08_04read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">
												<b> ${item.title}</b>
