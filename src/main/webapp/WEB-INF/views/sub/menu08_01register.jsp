	...
	<div id="main" class="scroll-container">
		<section class="section1">
			<div class="inner">
				...
				<div class="form_wrap">
					<form name="inquire" id="form1" method="post" action="${pageContext.request.contextPath}/menu08_01register" enctype="multipart/form-data">
					<input type="hidden" name="secret" id="secret" value="o">
						...
						<table class="board-cousel-form">							
							...
							<tr>
								<th>제목</th>
								<td>
									<input type="text" name="title" id="title" maxlength="500" value="" style="width:70%;">
								</td>
							</tr>
							<tr>
								<th>연락처</th>
							...
							<div class="inner1">
								<ul>
									...
									<li class="fr">
										...
										<button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/menu08_01register'">취소</button>
									</li>
								</ul>
							</div>
						</div><!-- btn-group end -->
