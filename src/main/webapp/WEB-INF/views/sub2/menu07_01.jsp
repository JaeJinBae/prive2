		...
		<section class="section1">
			<div class="inner">
				...
				<div class="formWrap">
						        ...
						        <c:forEach var="item" items="${list}">
									<tr>
										...
										<td class="subject" data-state="비공개">
											...
											<a href="${pageContext.request.contextPath}/menu07_01pwChk${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.title} <img src="${pageContext.request.contextPath}/resources/img/common/20180807_FD7F4F2AEC4341BF.png" alt="비공개" class="secret"></a>
										</td>
							    ...
							    <c:otherwise>
							        ...
							        <c:forEach var="item" items="${list}">
										<li>
											...
											<a href="${pageContext.request.contextPath}/menu07_01pwChk${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">
												<b><!---->${item.title}</b>
					...
					<div class="btn-group">
						<div class="inner">
							<a href="${pageContext.request.contextPath}/menu07_01register" class="btn btn-list">글쓰기</a>
						</div>
					</div>
					<!-- 게시판 버튼 끝 -->
