...
<body>
	...
	<div id="main" class="scroll-container">
		<section class="section1">
				...
				<ul class="inner">
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/menu05_00read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/menu05_00read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
				</ul>
			...
			<div class="btn-group">
				<div class="inner">
					<a href="${pageContext.request.contextPath}/menu05_00${pageMaker.makeSearch(pageMaker.cri.page)}" class="btn btn-list">목록으로</a>
				</div>
			</div>
			<!-- 게시판 버튼 끝 -->
			</div><!-- inner end -->
