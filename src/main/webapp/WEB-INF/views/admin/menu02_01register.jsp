		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				...
				<div class="write_area">
					<form id="form1" method="post" action="${pageContext.request.contextPath}/admin/menu02_01register${pageMaker.makeSearch(pageMaker.cri.page)}">
						<div class="write_box">
						...
						<div class="btn_area">
							...
							<p class="btn_right">
								...
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu02_01register'">취소</button>
							</p>
						</div>
					</form>
				</div>
