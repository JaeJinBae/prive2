...
<script src="${pageContext.request.contextPath}/resources/js/jquery-1.12.4.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/js/jquery-ui-1.11.1.js" type="text/javascript"></script>
									...
									<c:otherwise>
								        <c:forEach var="item" items="${list}">
											<tr class="cont">
												...
												<td>${item.no}</td>
												<td><a href="${pageContext.request.contextPath}/admin/menu02_01update${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}"><p class="title">${item.title}</p></a></td>
												<td><a href="${pageContext.request.contextPath}/admin/menu02_01update${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">${item.startdate} ~ ${item.enddate}</a></td>
