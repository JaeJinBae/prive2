...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/landing2/m/js/slick.js"></script>
	<!-- utf-8 환경 common.js -->
	...
	<div id="wrap">
		...
		<div id="header">
			<ul class="header_img">
				...
				<li class="logo"><img src="${pageContext.request.contextPath}/resources/landing2/m/image/logo.jpg?ver=1" alt="프라이브피부과 로고" /></li>
				<li class="tel"><a href="tel:1800-5475"><img src="${pageContext.request.contextPath}/resources/landing2/m/image/tel.jpg?ver=1" alt="프라이브피부과 연락처 1800-5475" /></a></li>
			</ul>
			<p><img src="${pageContext.request.contextPath}/resources/landing2/m/image/header.jpg" alt="프라이브가 최고라고 말할 수 없습니다. 하지만 프라이브는 최적의 진료 방법을 함께 고민하고 공감합니다." /></p>
		</div>
		<!-- 팝업-->
		...
		<div id="content">
			...
			<div><img src="${pageContext.request.contextPath}/resources/landing2/m/image/main6.jpg" alt="메인6" /></div>	
			...
			<!-- <div class="main12">
				...
				<div class="slide_wrap">
					<ul class="slide">
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list01.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list02.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list03.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list04.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list05.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list06.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list07.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list08.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list08.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list09.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list10.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list11.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list12.jpg" alt="프라이브피부과 내부" /></li>
						<li><img src="${pageContext.request.contextPath}/resources/landing2/m/image/space_list13.jpg" alt="프라이브피부과 내부" /></li>
					</ul>
				</div>
			</div>	
			<div class="main13">
				...
				<div class="ha_info">
					...
					<div class="info_sns">
						<ul>
							<li><a href="https://blog.naver.com/priveprive" target="_blank"><img src="${pageContext.request.contextPath}/resources/landing2/m/image/sns_list01.png" alt="프라이브피부과 블로그 링크이동" /></a></li>
							<li><a href="https://www.facebook.com/priveskin1" target="_blank"><img src="${pageContext.request.contextPath}/resources/landing2/m/image/sns_list02.png" alt="프라이브피부과 페이스북 링크이동" /></a></li>
							<li><a href="https://www.instagram.com/priveskin" target="_blank"><img src="${pageContext.request.contextPath}/resources/landing2/m/image/sns_list03.png" alt="프라이브피부과 인스타그램 링크이동" /></a></li>
					...
					<div class="db">
						...
						<div class="db_submit">
							<input type="image" src="${pageContext.request.contextPath}/resources/landing2/m/image/db_submit.png" />
						</div>
						<div class="kakao_btn">
							<a href="http://pf.kakao.com/_HbkxkT/chat"><input type="image" src="${pageContext.request.contextPath}/resources/landing2/m/image/db_kakao.png" /></a>
						</div>
					</div>
					</form>
				</div>
