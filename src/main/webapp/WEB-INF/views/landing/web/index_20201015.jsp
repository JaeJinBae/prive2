...
<body>
	<div id="wrap">
		    ...
		    <div class="header_inner">
				...
				<div class="header_tel">
					<ul>
						...
						<li class="home_btn"><a href="http://www.prive.co.kr/"><img src="${pageContext.request.contextPath}/resources/landing/image/home.png" alt="프라이브피부과 홈페이지 바로가기 링크이동" /></a></li>
					</ul>
				</div>
		...
		<div id="content">
			...
			<div class="main_member_new0901"></div>
			<div class="main3_new0901"></div>
			<div class="main4_new0901"></div>
			<div class="main5_new0901"></div>
			<div class="main6_new0901"></div>
			<div class="main7_new0901"></div>
			<div class="main8_new0901"></div>
			<div class="main9_new0901"></div>
			<div class="main10_new0901"></div>
			<div class="main11_new0901"></div>
			<!-- 20200901 수정본 끝-->
		</div>
		<!-- //content -->
		<!-- footer -->
